        ...
        <section class="bg-secondary py-5">
            <div class="container">
                <div class="row align-items-center py-5">
                    ...
                    <div class="col-md-4">
                        <img src="{{asset('img/about-hero.s')}}vg" alt="About Hero">
                    </div>
                </div>
            </div>
        </section>
