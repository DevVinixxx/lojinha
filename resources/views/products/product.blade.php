            ...
            <div class="container pb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h1 class="h2">Ttile product</h1>
                                    <p class="h3 py-2">R$ valor</p>
                                    ...
                                    <h6>Description:</h6>
                                    <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illum dicta rem laborum necessitatibus magnam corporis dolorum ipsa, quam totam ipsam porro quis enim accusantium consectetur doloribus? In laboriosam mollitia quod. </p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
